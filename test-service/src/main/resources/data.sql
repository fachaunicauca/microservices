...
INSERT INTO question (questionText, questionTitle, questionImageUrl, testId, questionType, questionStructure) VALUES
    ...
    ( '¿Qué debe hacer un estudiante si se derrama un reactivo químico en la piel?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
    ...
    ( '¿Qué se debe hacer con los desechos químicos generados en el laboratorio?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
    ...
    ( '¿Cuál es el propósito de las gafas de seguridad en un laboratorio de química?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
    ...
    ( '¿Qué debe hacer un estudiante si detecta un incendio en el laboratorio?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
    ...
    ( '¿Por qué es importante mantener el área de trabajo limpia en un laboratorio de química?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
    ...
    ('¿Qué acción debe tomarse si una persona tiene una quemadura química?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
    ...
    ('¿Dónde se deben almacenar los productos químicos en el laboratorio?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
    ...
    ('¿Qué tipo de extintor se utiliza para fuegos causados por líquidos inflamables?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
...
INSERT INTO question (questionText, questionTitle, questionImageUrl, testId, questionType, questionStructure) VALUES
    ...
    ('¿Qué debe hacer un estudiante si se siente mareado o intoxicado en el laboratorio?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
    ...
    ( '¿Qué debe estar siempre disponible en un laboratorio de química?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
    ...
    ('¿Qué se debe hacer con las sustancias químicas caducadas?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
    ...
    ('¿Por qué es importante no comer ni beber en el laboratorio de química?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
    ...
    ('¿Cómo se debe manipular un vaso medidor en el laboratorio?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
    ...
    ('¿Qué equipo se debe utilizar para protegerse del riesgo de inhalación de vapores tóxicos?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
    ...
    ('¿Dónde se encuentra el equipo de emergencia en un laboratorio?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
    ...
    ('¿Qué precaución debe tomarse al trabajar con líquidos inflamables?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
    ...
    ('¿Qué se debe hacer en caso de que un compañero de laboratorio sufra una quemadura?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
    ...
    ('¿Cuál es el procedimiento correcto para diluir un ácido?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
    ...
    ('¿Qué se debe hacer antes de encender un mechero Bunsen?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
    ...
    ('¿Qué equipo se debe usar para calentar sustancias de forma segura?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
    ...
    ('¿Cuál es la medida de seguridad más importante al manejar sustancias corrosivas?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
...
INSERT INTO question (questionText, questionTitle, questionImageUrl, testId, questionType, questionStructure) VALUES
   ...
   ( '¿Qué se debe hacer si se rompe un termómetro de mercurio?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
   ...
   ('¿Qué característica debe tener el calzado para trabajar en el laboratorio?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
   ...
   ( '¿Cuál es la función de la ducha de seguridad?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
   ...
   ( '¿Cómo se debe pipetear una solución química?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
   ...
   ('¿Qué indica el pictograma de una llama sobre un círculo?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
   ...
   ('¿Qué se debe hacer con el cabello largo en el laboratorio?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
   ...
   ('¿Cómo debe ser el etiquetado de un frasco con una solución preparada?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
   ...
   ('¿Qué riesgo principal representa el uso de lentes de contacto en el laboratorio?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
   ...
   ( '¿Qué se debe hacer si una probeta de vidrio se agrieta?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
   ...
   ('¿Cuál es la forma correcta de calentar un tubo de ensayo a la llama?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
   ...
   ('¿Qué significa el pictograma de una calavera y tibias cruzadas?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
   ...
   ('¿Qué debe hacerse si el gas de un mechero no enciende tras varios intentos?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
   ...
   ('¿Cómo se deben transportar los tubos de ensayo?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
...
INSERT INTO question (questionText, questionTitle, questionImageUrl, testId, questionType, questionStructure) VALUES
   ...
   ('¿Cuál es la forma segura de oler una sustancia química en el laboratorio?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
   ...
   ( '¿Qué se debe hacer con los recipientes vacíos que contenían reactivos peligrosos?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
   ...
   ( '¿Qué significa el pictograma de un signo de exclamación en un rombo rojo?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
   ...
   ( '¿Cómo se debe actuar si una sustancia química entra en contacto con los ojos?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
   ...
   ('¿Cuál es la función principal de la bata de laboratorio?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
   ...
   ( '¿Qué precaución se debe tener con las placas calefactoras encendidas?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
   ...
   ('¿Qué debe hacerse con los guantes desechables después de su uso?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
   ...
   ('¿Cómo se debe almacenar una solución volátil?', NULL, NULL, 1, 'MULTIPLE_CHOICE',
